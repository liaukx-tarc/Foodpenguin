...
public class MCD3 extends Fragment implements View.OnClickListener, AdapterView.OnItemSelectedListener{
    ImageButton back;
    Button cart;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @NonNull ViewGroup container, @NonNull Bundle savedInstanceState) {
        ...
        View view =  inflater.inflate(R.layout.fragment_m_c_d3, container, false);
